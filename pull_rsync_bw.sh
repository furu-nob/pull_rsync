...
#RSYNC='/usr/bin/rsync -auvz -e ssh --rsync-path="/home/anaheim/scripts/rsync.sh" --delete --dry-run'
#RSYNC='/usr/bin/rsync -auvz -e ssh --rsync-path="/home/anaheim/scripts/rsync.sh" '
#RSYNC='/usr/bin/rsync -auvz --bwlimit=100 -e ssh --rsync-path="/home/anaheim/scripts/rsync.sh" '
...
then
  ...
  RSYNC="/usr/bin/rsync -auvz --bwlimit=$4 -e ssh --rsync-path="/home/anaheim/scripts/rsync.sh" "
fi
...
function show_help {
  ...
  echo "****************"
  echo ""
  echo "\$ $0 remote_server remote_dir local_dir BANDWIDTH"
